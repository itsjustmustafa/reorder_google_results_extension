  ...
  setTimeout(
    () =>
      prioritiseResults(
        ...
        results_site_selector,
      ),
    wait_time,
  );
}

function prioritiseResults(
  current_page_url,
  results_div_selector,
  results_item_selector,
  results_site_selector,
  ...
  const search_results = Array.from(
    search_results_div.querySelectorAll(results_item_selector),
  );
  ...
  search_results
    ...
    .forEach(function (childElement) {
      const cite_elements = childElement.querySelectorAll(
        results_site_selector,
      );
      ...
      if (needs_to_swap) {
        ...
        search_results_div.insertBefore(
          childElement,
          search_results_div.firstChild,
        );
      }
    });
}
